...
export const get_alarm_type_rule = (data) => {
    return axios.request({
        url: 'http://localhost:8093/static/json/alarmType.json',
        method: 'get',
        params: data.queryData,
        data: data.paramsData,
    }).then(result => {
...
export const get_rule_attack_result = (data) => {
    return axios.request({
        url: 'http://localhost:8093/static/json/attackResult.json',
        method: 'get',
        params: data.queryData,
        data: data.paramsData,
    }).then(result => {
...
export const getAssetsSelect = (data) => {
    return axios.request({
        url: 'http://localhost:8093/static/json/assetSelect.json',
        method: 'get',
        data: data,
    }).then(result => {
        console.log(result);
...
export const getSubjectLabel = (data) => {
    return axios.request({
        url: 'http://localhost:8093/static/json/label.json',
        method: 'get',
        data: data,
    }).then(result => {
        console.log(result);
