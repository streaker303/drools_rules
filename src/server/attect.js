...
export const getDrools = (data) => {
	return axios.request({
		url: 'http://localhost:8093/static/json/ruleList.json',
		method: 'get',
...
export const selectResourcePool= (data) => {
	return axios.request({
		url: 'http://localhost:8093/static/json/resourcePool.json',
		method: 'get',
		data: data,
	}).then(result => {
		console.log(result);
...
export const get_fields= (data) => {
    return axios.request({
        url: 'http://localhost:8093/static/json/field.json',
        method: 'get',
        data: data,
    }).then(result => {
        console.log(result);
...
export const get_extendRules= (data) => {
    return axios.request({
        url: 'http://localhost:8093/static/json/extendRule.json',
        method: 'get',
        params: data.queryData,
        data: data.paramsData,
    }).then(result => {
...
export const get_mail_users= (data) => {
    return axios.request({
        url: 'http://localhost:8093/static/json/mail.json',
        method: 'get',
        data: data,
    }).then(result => {
        console.log(result);
